...
<Head>
  <title>React State Management using Redux workshop</title>
</Head>
...
Slides: TODO: http://bit.ly/react-state-slides

Workshop repo: TODO: http://bit.ly/react-state-workshop

---

## What will we learn today?

- Refresher on the previous workshops
- Redux basic elements
- Redux debugging
- Redux middleware - hard way
- Where to look for an easy way :)
...
Prop drilling
For big projects - this will be an overshoot
...
1. Pull the workshop repository TODO: http://bit.ly/react-state-workshop
